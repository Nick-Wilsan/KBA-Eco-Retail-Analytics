...
def materialize(df, con):
    ...
    tmp_name = '__dbt_python_model_df_' + 'gold_anomaly_check__dbt_tmp'
    con.register(tmp_name, df)
    con.execute('create table "warehouse"."gold"."gold_anomaly_check__dbt_tmp" as select * from ' + tmp_name)
